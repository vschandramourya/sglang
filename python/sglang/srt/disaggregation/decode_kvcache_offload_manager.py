...
class DecodeKVCacheOffloadManager:
    ...
    def _trigger_backup(
        ...
        This is acceptable for PD disaggregation where:
        - Pre-prefill node writes to L3 (uses write_through)
        - Normal prefill node reads from L3 (uses write_back)
        - Decode node only needs host memory as temporary buffer
        """
