...
def publish_traces(traces_dir, run_id, run_number, is_vlm=False):
    ...
    repo_owner = os.getenv("GITHUB_CI_DATA_REPO_OWNER", "togethercomputer")
    repo_name = os.getenv("GITHUB_CI_DATA_REPO_NAME", "tgl-ci-data")
    branch = os.getenv("GITHUB_CI_DATA_BRANCH", "data")
